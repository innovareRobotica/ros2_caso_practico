...
// Nodo "Planificador_Ruta", encargado de publicar eventos viales, como intersecciones
class PlanificadorRuta : public rclcpp::Node
{
public:
  PlanificadorRuta()
  : Node("Planificador_Ruta"), count_(500) // Inicializa el nodo y el contador de distancia
  {
...
int main(int argc, char * argv[])
{
  ...
  // Crea y mantiene en ejecución el nodo "Planificador_Ruta"
  rclcpp::spin(std::make_shared<PlanificadorRuta>());
